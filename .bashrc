...
alias sshstart='sudo systemctl start sshd.service'
...
alias goback='nohup ~/program/goagent/local/proxy.py &> /dev/null'
...
PATH=$PATH:/usr/local/bin:$GOPATH/bin:/opt/android-sdk/tools
